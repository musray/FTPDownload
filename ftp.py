...
__version__ = 'Rev 0.3, Nov.14th, 2014'
...
dir_group = {'AB-MIT-3-CTE'  : '/01.项目文件/00.CPR1000项目/04.CPR1000 PROJECT E/00_收发文件/MIT-CTE/35000~39999/',
	     ...
	     'AA-CTE-0-MIT'  : '/01.项目文件/00.CPR1000项目/02.CPR1000 PROJECT C/00_收发文件/CTE-MIT/05001-06999/',
		 'YMIT-0-YCTE'   : '/01.项目文件/00.CPR1000项目/03.CPR1000 PROJECT D/00_收发文件/YMIT-YCTE/00001-09999/',
		 'YMIT-3-YCTE'   : '/01.项目文件/00.CPR1000项目/03.CPR1000 PROJECT D/00_收发文件/YMIT-YCTE/35000-36999',
	  ...
	  'YSDM-36-YAEQ-IITF': '/01.项目文件/00.CPR1000项目/03.CPR1000 PROJECT D/00_收发文件/YSDM-YAEQ/360000-399999/IITF',
		   ...
		   'YCTE-0-YMIT' : '/01.项目文件/00.CPR1000项目/03.CPR1000 PROJECT D/00_收发文件/YCTE-YMIT/00001-09999',
		   'YCTE-3-YMIT' : '/01.项目文件/00.CPR1000项目/03.CPR1000 PROJECT D/00_收发文件/YCTE-YMIT/35000',
...
def patternGenerator(user_input):
	...
	if channel_number[0] == '3' and label.find('II') != -1:
		...
		label = new_label[:]
	elif (channel_number[0:2] == '99' or channel_number[0] == '0') and label[1:5].find('SD') != -1:
		new_label = ''
		aeq_ane = raw_input('Is it SD*-0/99-ANE or SD*-0/99-AEQ?\
				\n\tpress "ENTER" for ANE\
